          ...
          <div class="accordion-group">
            ...
            <div id="kitchen" class="accordion-body collapse in">
              <div class="accordion-inner">
						...
						and energy.<br /> #4 If your dishwasher is new, cut back on
						rinsing. Newer models clean more thoroughly than older ones.<br />
						#5 Designate one glass for your drinking water each day, or refill
						a water bottle. This will cut down on the number of glasses to
						wash.<br /> #6 Soak pots and pans instead of letting the water
						run while you scrape them clean.<br /> #7 Use the garbage
          ...
          <div class="accordion-group">
            ...
            <div id="laundry" class="accordion-body collapse">
              <div class="accordion-inner">
						...
						shopping for a new washing machine, compare resource savings among
						Energy Star models. Some can save up to 20 gallons of water per
						load.<br /> #4 Have a plumber re-route your greywater to trees
						and plants rather than the sewer line. Check with your city and
          ...
          <div class="accordion-group">
            ...
            <div id="bathroom" class="accordion-body collapse">
              <div class="accordion-inner">
						...
						toilet. It has two flush options: a half-flush for liquid waste
						and a full-flush for solid waste.<br /> #13 Plug the sink instead
						of running the water to rinse your razor and save up to 300
						gallons a month.<br /> #14 Turn off the water while washing your
						hair and save up to 150 gallons a month.<br /> #15 When washing
						your hands, turn the water off while you lather.<br /> #16 Take
						5-minute showers instead of baths. A full bathtub requires up to
						70 gallons of water.<br /> #17 Install water-saving aerators on
						all of your faucets.<br /> #18 Drop tissues in the trash instead
						of flushing them and save water every time.<br /> #19 Look for
						WaterSense® labeled toilets, sink faucets, urinals and
						showerheads.<br /> #20 One drip every second adds up to five
          ...
          <div class="accordion-group">
            ...
            <div id="in-general" class="accordion-body collapse">
              <div class="accordion-inner">
						...
						the kids want to cool off, use the sprinkler in an area where your
						lawn needs it most.<br /> #4 Encourage your school system and
						local government to develop and promote water conservation among
						children and adults.<br /> #5 Play fun games while learning how
						to save water!<br /> #6 Monitor your water bill for unusually
						high use. Your bill and water meter are tools that can help you
						discover leaks.<br /> #7 Learn how to use your water meter to
						...
						water and money.<br /> #17 Run your washer and dishwasher only
          ...
          <div class="accordion-group">
            ...
            <div id="xlandscape" class="accordion-body collapse in">
              <div class="accordion-inner">
						...
						underwatering others.<br /> #3 Choose the right Arizona-friendly
						plants and watch them thrive in our desert environment.<br /> #4
						Reduce the amount of lawn in your yard by planting shrubs and
						ground covers appropriate to your site and region.<br /> #5 Plant
						species native to your region.<br /> #6 Plant in the spring and
						fall, when the watering requirements are lower.<br /> #7 When
						sprucing up your front or backyard, consider xeriscaping. This
						landscape method uses low-water-use plants to limit your water
						use.<br /> #8 Consider attending a landscape class hosted by a
						water provider. Most workshops occur in the spring and fall.<br />
						#9 Avoid planting grass in areas that are hard to water, such as
						steep inclines and isolated strips along sidewalks and driveways.<br />
						#10 Leave lower branches on trees and shrubs and allow leaf litter
						to accumulate on the soil. This keeps the soil cooler and reduces
						evaporation.<br /> #11 Start a compost pile. Using compost in
						your garden or flower beds adds water-holding organic matter to
						the soil.<br /> #12 Use a layer of organic mulch on the surface
						of your planting beds to minimize weed growth that competes for
						water.<br /> #13 Spreading a layer of organic mulch around plants
						helps them retain moisture, saving water, time and money.<br />
						#14 Use 2 to 4 inches of organic mulch around plants to reduce
						evaporation and save hundreds of gallons of water a year.<br />
						#15 Visit your local xeriscape garden to view plants that thrive
						in our hot desert environment.<br /> #16 Next time you add or
						replace a flower or shrub, choose a low-water-use plant and save
						up to 550 gallons each year.<br /> #17 Call your local
						conservation office for more information about xeriscaping with
						water-thrifty trees, plants, and ground covers.<br /> #18 Collect
						water from your roof by installing gutters and downspouts. Direct
          ...
          <div class="accordion-group">
            ...
            <div id="lawn" class="accordion-body collapse">
              <div class="accordion-inner">
						...
						training specific to the Sonoran Desert.<br /> #3 Adjust your
						lawn mower to the height of 1.5 to 2 inches. Taller grass shades
						roots and holds soil moisture better than short grass.<br /> #4
						Leave lawn clippings on your grass, this cools the ground and
						holds in moisture.<br /> #5 If installing a lawn, select a lawn
						...
						Avoid overseeding your lawn with winter grass. Ryegrass needs
						water every few days, whereas Dormant Bermuda grass needs water
						monthly.<br /> #10 Remember to weed your lawn and garden
						regularly. Weeds compete with other plants for nutrients, light
						and water.<br /> #11 While fertilizers promote plant growth, they
						also increase water consumption. Apply the minimum amount of
						fertilizer needed.<br /> #12 Water your summer lawns once every
          ...
          <div class="accordion-group">
            ...
            <div id="landscape" class="accordion-body collapse">
              <div class="accordion-inner">
						...
						only your lawn is watered and not the house, sidewalk or street.<br />
						#5 Minimize evaporation by watering during the early morning hours
						when temperatures are cooler and winds are lighter.<br /> #6
						Timing is everything when it comes to irrigation. Learn how to set
						your controller properly.<br /> #7 Look for WaterSense® labeled
						irrigation controllers.<br /> #8 Learn how to shut off your
						automatic watering system in case of malfunctions or rain.<br />
						#9 Apply water only as fast as the soil can absorb it.<br /> #10
						If water runs off your lawn easily, split your watering time into
						shorter periods to allow for better absorption.<br /> #11 Water
						only when necessary. More plants die from over-watering than from
						under-watering.<br /> #12 Signs of overwatering: Leaves turn
						lighter shades of green or yellow, young shoots wilt, and
						...
						before hitting the ground.<br /> #20 Use a rain barrel to harvest
						rainwater from gutters for watering gardens and landscapes.<br />
						#21 For hanging baskets, planters and pots, put ice cubes on top
						of the soil to give your plants a cool drink of water without
          ...
          <div class="accordion-group">
            ...
            <div id="pool" class="accordion-body collapse">
              <div class="accordion-inner">
					...
					recirculating pumps.<br /> #3 If you have an automatic refilling
					device, check your pool periodically for leaks.<br /> #4 When
					...
					cascading fountains lose less water to evaporation than those that
          ...
          <div class="accordion-group">
            ...
            <div id="out-general" class="accordion-body collapse">
              <div class="accordion-inner">
					...
					more efficient cooling, check your evaporative cooler annually.<br />
					#10 If you have an evaporative cooler, direct the water drain to
					plants in your landscape.<br /> #11 Set water softeners for a
					minimum number of refills to save both water and chemicals, plus
					energy, too.<br /> #12 If you have an evaporative cooler, install
					a recirculating pump to keep water from bleeding off with one pass.<br />
					#13 Report broken pipes, leaky hydrants and errant sprinklers to
					property owners or your local water provider.<br /> #14 Know where
					your master water shut-off valve is located. Were a pipe to burst,
