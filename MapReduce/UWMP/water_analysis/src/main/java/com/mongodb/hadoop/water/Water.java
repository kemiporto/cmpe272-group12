...
/**
 * The water xml config object.
 */
public class Water extends Configured implements Tool {
    private static final Log LOG = LogFactory.getLog(Water.class);
    ...
    public int run(final String[] args) throws Exception {
        ...
        final Job job = new Job(conf, "water-analysis");
    ...
    public static void main(final String[] pArgs) throws Exception {
        System.exit(ToolRunner.run(new Water(), pArgs));
    }
}
